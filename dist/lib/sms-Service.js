...
exports.sms_service = exports.SMSService = void 0;
class SMSService {
    constructor() {
    ...
    async send_message(phoneNumber, messageText) {
        try {
            // Format phone number
    ...
    async send_bulk_messages(recipients) {
        const results = [];
    ...
    async validate_phone_number(phoneNumber) {
        try {
            const formatted_phone = this.format_phone_number(phoneNumber);
...
exports.sms_service = new SMSService();
